...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/code-qwen25-7b-reason-exec}"
...
CMD=(
  ...
  --reason_weight "${REASON_WEIGHT:-0.2}"
  ...
  --uplift_repeats "${UPLIFT_REPEATS:-3}"
  --rm_score_url "${RM_SCORE_URL}"
  --rm_max_length "${RM_MAX_LENGTH:-3072}"
